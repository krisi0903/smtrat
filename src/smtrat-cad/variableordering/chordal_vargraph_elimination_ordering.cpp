...
namespace smtrat::cad::variable_ordering {
    ...
    /*
    std::vector<carl::Variable> weighted_etree(const std::vector<Poly>& polys) {
        struct DoubleWeightedVariableEdgeProperties {
            std::map<carl::Variable, int> weight;
        }
        typedef boost::adjacency_list<boost::setS, boost::setS, boost::undirectedS, VariableVertexProperties, DoubleWeightedVariableEdgeProperties> ChordalStructure;
